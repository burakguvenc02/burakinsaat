...
<?php 
$projesor=$db->prepare("SELECT * FROM projeler where proje_durum='2' ");
$projesor->execute();
...
<div class="filters-section">
            <div class="container">
                <div class="title-def">
                <h2 style="margin-top: 100px;">Bitmis Olan Projelerimiz</h2>
                </div>
                ...
                <div class="esg-filter-wrapper   tm-skin esg-fgc-3">
                    ...
                    <a href="devamproje"><div class="esg-filterbutton " data-fid="14" data-filter="filter-design"><span>Yapımda Olan Projeler</span><span class="esg-filter-checked"><i class="eg-icon-ok-1"></i></span></div>
...
<div class="section white">
	...
	<?php 
$sayfa        = @intval($_GET['projesayfa']);if(!$sayfa) {$sayfa=1;} // burada hangi sayfada olduğumuzu buluyor
...
$gorunensayfa = 4;
$projeler     = $db->query("select * from projeler where proje_durum='2' order by proje_zaman DESC limit $goster,$limit");
					...
					<div class="col-sm-4">
						<div class="blog-post">
							...
							<div class="content">
								...
								<p><?php echo substr($projecek['proje_detay'],0,250) ?>
									</p>
...
<ul class="pagination">
	...
	<li class="say_sabit"><a href="bitmis-projeler.php?projesayfa=1">ilk</a></li>
	<li class="say_sabit"><a href="bitmis-projeler.php?projesayfa=<?=$sayfa - 1 ?>">Önceki</a></li>
<?php  } ?>	
<?php 
$s = 0;
...
while($s < $sayfa_sayisi) {
	...
	if($s==$sayfa){ ?>
		...
		<li class="active">
			<a href="bitmis-projeler.php?projesayfa=<?php echo $s; ?>"><?php echo $s; ?></a> 
		</li>
...
<li class="say_sabit"><a href="bitmis-projeler.php?projesayfa=<?=$sayfa + 1?>">Sonraki</a></li>
<li class="say_sabit"><a href="bitmis-projeler.php?projesayfa=<?=$sayfa_sayisi?> ">Son</a></li>
<?php } ?>      
</ul>
