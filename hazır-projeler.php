...
<div class="responsive-menu">
  ...
  <div  class="filters-section">
            <div  class="container">
                <div class="title-def">
                <h2  style="margin-top: 100px;"> Hazır Projelerimiz</h2>
                </div>
...
<?php 
$sayfa        = @intval($_GET['hazırproje']);if(!$sayfa) {$sayfa=1;} // burada hangi sayfada olduğumuzu buluyor
...
$gorunensayfa = 4;
$projeler     = $db->query("select * from projeler where proje_durum='0'  order by proje_zaman DESC limit $goster,$limit");
...
<ul  class="pagination">
	...
	<li class="say_sabit"><a href="hazır-projeler.php?hazırproje=1">ilk</a></li>
	<li class="say_sabit"><a href="hazır-projeler.php?hazırproje=<?=$sayfa - 1 ?>">Önceki</a></li>
<?php  } ?>	
<?php 
$s = 0;
...
while($s < $sayfa_sayisi) {
	...
	if($s==$sayfa){ ?>
		...
		<li class="active">
			<a href="hazır-projeler.php?hazırproje=<?php echo $s; ?>"><?php echo $s; ?></a> 
		</li>
...
<li class="say_sabit"><a href="hazır-projeler.php?hazırproje=<?=$sayfa + 1?>">Sonraki</a></li>
<li class="say_sabit"><a href="hazır-projeler.php?hazırproje=<?=$sayfa_sayisi?> ">Son</a></li>
<?php } ?>      
</ul>
